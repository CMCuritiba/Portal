...
const EditoriaItemView = (props) => {
  ...
  return (
    <section>
      <div className="background-white pb-38">
        <div className="container px-mb-20">
          <h1 className="fs-48 fw-600 fs-mb-32">{content?.title}</h1>
          <p className="fs-24 fw-400 lh-normal fs-mb-18">{content?.description}</p>
        </div>
      </div>
      <div className="container px-mb-20">
        <div className="stack gap-24 news-noticia">
          <div className="container">
            <div className="stack row gap-24 mobile-flex-direction-col">
                  ...
                  <>
                    <div className="destaque destaques-home">
                      <div className="card-default px-24 py-24 w-100">
                        ...
                        <div className="mt-16">
                          <h2 className="text-black fs-32 fw-600 title-32 fs-mb-24">
                            {items[0]?.title}
                          </h2>
                          <div className="mt-16">
                      ...
                      {items.slice(1, 5).map((item, index) => (
                        <div key={index} className="card-default py-24 px-24">
                          <div>
                            ...
                            <div className="mt-16">
                              <h2 className="title-32 fs-mb-24">
                                {item?.title}
                              </h2>
                            </div>
                          </div>
