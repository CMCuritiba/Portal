            ...
            <div className="container w-100-w">
                <div className="grid-col-3 gap-32 overflow-auto-mobile child-75vw">
                    <div className="card-default card">
                        ...
                        <div
                            className="px-16 py-16 stack flex-column gap-16 flex-between align-items-start flex-auto">
                                ...
                                <span className="tag-agenda">
                                       <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="#637381" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M6.50022 10.834L10.3336 8.65397L6.50022 6.47397V10.834Z"
                                                  stroke="#637381" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        Youtube da Câmara de Curitiba
                                    </span>
                            </div>
                            <a className="button button-third w-100">
                                Saiba mais
                            </a>
                        </div>
                    </div>
                    <div className="card-default card">
                        <div className="position-relative">
                            <img src="/images/agenda/agenda-2.png" className="w-100 aspect-ratio-16-9"/>
                            <div className="agenda-data">
                                    <span>
                                        13
                                    </span>
                        ...
                        <div
                            ...
                            <div className="flex-1-auto stack flex-column gap-16 flex-start align-items-start">
                                ...
                                <h3 className="fs-18 fw-600 mt-0 mb-0">
                                    Tema: Gestão de resíduos sólidos e licitação de limpeza urbana.
                                </h3>
                                <span className="tag-agenda">
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="tag-agenda">
                                        ...
                                        <rect width="16" height="16" fill="white" transform="translate(0 0.320312)"/>
                                        </clipPath>
                                        </defs>
                                        </svg>
