...
class IVereador(model.Schema):
    ...
    partido = schema.Choice(
        title="Partido",
        required=True,
        vocabulary="cmcuritiba.partidos",
    )

    legislatura = schema.List(
        title="Legislatura",
        required=True,
        value_type=schema.Choice(vocabulary="cmcuritiba.legislaturas"),
    )
    ...
    cargo_mesa_diretora = schema.Choice(
        ...
        required=False,
        vocabulary="cmcuritiba.cargos_mesa_diretora",
    )
    ...
    cargo_corregedoria = schema.Choice(
        ...
        required=False,
        vocabulary="cmcuritiba.cargos_corregedoria",
    )
    ...
    noticias_relacionadas = schema.List(
        ...
        value_type=schema.Choice(
            title="Notícia", vocabulary="cmcuritiba.news_items"
        ),
    )
