...
# Câmara de Curitiba build configuration file
...
project = "Câmara de Curitiba"
author = "Digigroup e DTIC"
trademark_name = "cmcuritiba"
now = datetime.now()
year = str(now.year)
copyright = year
...
linkcheck_ignore = [
    ...
    r"https://github.com/cmcuritiba/câmaradecuritiba/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/cmcuritiba/câmaradecuritiba",
    ...
    "logo": {
        "text": "Câmara de Curitiba",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/cmcuritiba/câmaradecuritiba",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/cmcuritiba/câmaradecuritiba/edit/main/docs/",
# }
...
ogp_site_name = "Câmara de Curitiba Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Câmara de CuritibaDocumentation"
...
latex_documents = [
    (
        "index",
        "Câmara de CuritibaDocumentation.tex",
        "Câmara de Curitiba Documentation",
        "cmcuritiba community",
        "manual",
    ),
]
