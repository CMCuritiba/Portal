...
# Script para forçar imediatamente uma release de homolog
# Uso: ./scripts/force-homolog-now.sh

set -e

echo "🚀 Forçando release de homolog imediatamente..."
echo ""
...
echo ""
echo "⏳ Aguarde alguns minutos para o workflow executar..." 